...
public class ShoppingItem implements Serializable {
    private final static String REGEX = "<(/)?([a-zA-Z]*)(\\s[a-zA-Z]*=[^>]*)?(\\s)*(/)?>";
    ...
    public String getTitleExceptHtmlTag() {
    ...
    public String getFullCategory() {
        ...
        if(category2 != null && !category2.equals("")) {
            ...
            stringBuilder.append(category2);
        }
        if(category3 != null && !category3.equals("")) {
            stringBuilder.append('>');
            stringBuilder.append(category3);
        }if(category4 != null && !category4.equals("")) {
            stringBuilder.append('>');
            stringBuilder.append(category4);
        }
